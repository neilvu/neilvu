...
As a data analytics aspirant, I am passionate in learning how to abstract data using a variety of different programming languages that I already had experienced on like SQL, R, Power BI, and Tableau in order to analyze data content for investigative analysis. Through learning basic auditing and data analytics skills, the projects that I am currently working are applicable to real-life scenarios like designing database to abstraction and then analysis in order to understand how data analytics can lead to different ways of life as well with possible issues to provide a more justifiable solution by understanding what issues are aligned with fraud, waste and abuse or other factors to make better decisions for everyone. 

By working on projects, it will help me get a sense of what the data/programming environment is and the bigger picture as well. I look forward to work on professional certification(s) as well going above to make a difference throughout this career, whether on government, management or law enforcement to improve accountability and transparency.
