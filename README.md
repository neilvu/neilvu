...
As a data analytics aspirant, I am passionate in learning how to abstract data using a variety of different programming languages that I already had experienced on like SQL, R, Power BI, and Tableau in order to analyze data for investigative analysis. Through learning basic auditing and data analytics skills, the projects that I am currently working are applicable to real-life scenarios like designing database to abstraction and then analysis in order to understand how data analytics can lead to different ways of life as well with possible issues to provide a more justifiable solution by understanding what issues are aligned with fraud, waste and abuse or other factors to make better decisions for everyone. 
